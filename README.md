...
This project is a serverless notification pipeline that ingests files via Amazon S3, stores metadata in DynamoDB, and sends structured alerts 
to Email and Slack (Enterprise Grid) using AWS Lambda and SNS.


 Components of my Enterprise notification using SNS Topic and subscription, Amazon S3, DynamoDB, WEBHOOK URL and Lambda
...
Whenever i upload an html file into my s3 bucket.

Lambda is triggered automatically.

Metadata is stored in DynamoDB.

SNS sends a message to Slack webhook and Email
